...
When the same option is provided both via CLI argument and in the config file, the CLI argument SHALL take precedence. This applies to `--target`, `--mount`, and `--disk-size`.
