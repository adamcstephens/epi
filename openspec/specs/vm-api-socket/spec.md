## Purpose
Define how the CLI configures cloud-hypervisor with an API socket for lifecycle control, and uses ch-remote for graceful shutdown via ExecStop commands.
