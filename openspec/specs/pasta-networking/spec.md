## Purpose
Define the pasta userspace networking integration for `epi up` so VMs obtain network access without requiring root privileges or CAP_NET_ADMIN on the host.
